...
dottedexpressionconstraint : subexpressionconstraint (ws dot ws (attributeoperator ws)? eclattributename)+;
...
eclattribute : (LEFT_BRACE cardinality RIGHT_BRACE ws)? (reverseflag ws)? (attributeoperator ws)? eclattributename ws ((expressioncomparisonoperator ws subexpressionconstraint) | (numericcomparisonoperator ws HASH numericvalue) | (stringcomparisonoperator ws qm stringvalue qm));
