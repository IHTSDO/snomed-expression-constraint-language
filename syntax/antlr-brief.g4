...
refinedexpressionconstraint : simpleexpressionconstraint ws COLON ws eclrefinement;
...
dottedexpressionconstraint : simpleexpressionconstraint (ws dot ws (attributeoperator ws)? eclattributename)+;
simpleexpressionconstraint : (constraintoperator ws)? (eclfocusconcept | (LEFT_PAREN ws expressionconstraint ws RIGHT_PAREN));
conjunctionexpressionconstraint : simpleexpressionconstraint (ws conjunction ws simpleexpressionconstraint)+;
disjunctionexpressionconstraint : simpleexpressionconstraint (ws disjunction ws simpleexpressionconstraint)+;
...
eclattribute : (LEFT_BRACE cardinality RIGHT_BRACE ws)? (reverseflag ws)? (attributeoperator ws)? eclattributename ws ((expressioncomparisonoperator ws simpleexpressionconstraint) | (numericcomparisonoperator ws HASH numericvalue) | (stringcomparisonoperator ws qm stringvalue qm));
